...
//--------------------- DDR --------------------- */
    ...
    {"TEE Reserved",      0x7E780000, 0x01740000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_BACK},
    {"SSPM Reserved",     0x7FEC0000, 0x00100000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_BACK},
    {"SCP Reserved",      0x9F900000, 0x00600000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_BACK},

    {"Display Reserved",  0x7D870000, 0x00F10000, AddMem, MEM_RES, SYS_MEM_CAP, Reserv, WRITE_THROUGH_XN},
